export default function Home() {
  ...
  return (
    ...
    <main className="flex relative min-h-screen flex-col bg-slate-500">
    ...
    <div className="flex flex-wrap justify-center p-8  bg-cyan-600">
    ...
    <div className="flex bg-teal-900 text-white px-28 justify-evenly ">
